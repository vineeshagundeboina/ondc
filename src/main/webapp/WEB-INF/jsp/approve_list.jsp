...
<c:if test="${not empty final_ref_no}">
<script>
	var v ="${final_ref_no}"; 
	 alert_box("success", "Application <strong> Ref No ."+v+"</strong> successfully approved");
</script>
</c:if>
                                    ...
                                    <div class="elements data-row row-23818">
                                        <div class="row tr">
                                            ...
                                            <div class="col-1 col-md-1 col">
                                                ...
                                                <form id="approvedapplnviewform${record.id}" method="post" action="approved-application">
                                                    <input type="hidden" name="applnformid"  id="applnformid"  value="${record.id}">
                                                    <button class="btn btn-info"  id="approvedappln${record.id}" type="submit">View</button>
                                                    </form>
                                            ...
                                            <c:if test="${login_users.userSession ne record.createdBy && login_users.depname ne  'OS' && login_users.depname ne 'fedserv'}">
                                                ...
                                                <div class="col-1 col-md-1 col">
                                                    ...
                                                    <form id="modifiedapplnviewform${record.id}" method="post" action="modified-application">
                                                        ...
                                                        <button class="btn btnspec btn-primary" id="modifiedapplnview${record.id}">Modify</button>
                                                    </form>
                                        ...
                                        <div class="row">
                                            <div class="col-auto mr-auto">
                                                ...
                                                <c:if test="${not empty  record.approvedBy}">
  ...
  <script src="./resources/assets/javascripts/function.js"></script>
    ...
    <script>
        jQuery(document).ready(function ($) {
            $('select').find('option[value=approved]').attr('selected', 'selected');
        });
    </script>
