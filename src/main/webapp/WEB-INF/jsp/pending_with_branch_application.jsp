                    ...
                    <div class="content-application-form">
                        <div class="card text-white mb-3">
                            <div class="card-header font-weight-bold  bg-info">
                                Application Status: &nbsp;&nbsp;<i class="text-uppercase">Pending With Branch </i>
                                <c:if test="${not empty  applicationDetails.resubmittedBy}"><span class="badge badge-danger">Resubmitted
                                        By : ${applicationDetails.resubmittedBy}</span></c:if>
                            </div>
                        </div>
                        <c:if test="${not empty  applicationDetails.resubmittedBy}">
                        ...
                        <c:if test="${applicationDetails.resubmittedBy eq null}">
                                    ...
                                    <div class="row">
                                        <div class="col-auto mr-auto">
                                            <c:if test="${not empty  applicationDetails.resubmittedAt}">
                                                ...
                                                <span class="badge badge-primary">
                                                    <fmt:formatDate value="${applicationDetails.resubmittedAt}" pattern="MMMM dd, YYYY hh:mm a" />
                                           </span>
                                            </c:if>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-auto mr-auto">
                                            <c:if test="${not empty  applicationDetails.rejectedAt}">
                                                ...
                                                <span class="badge badge-primary">
                                                    <fmt:formatDate value="${applicationDetails.rejectedAt}" pattern="MMMM dd, YYYY hh:mm a" />
                                            </span>
                                            </c:if>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-auto mr-auto">
                                            <c:if test="${not empty  applicationDetails.approvedAt}">
                                                ...
                                                <span class="badge badge-primary">
                                                    <fmt:formatDate value="${applicationDetails.approvedAt}" pattern="MMMM dd, YYYY hh:mm a" />
                                            </span></c:if>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-auto mr-auto">
                                            <c:if test="${not empty  applicationDetails.modifiedAt}">
                                                ...
                                                <span class="badge badge-primary">
                                                    <fmt:formatDate value="${applicationDetails.modifiedAt}" pattern="MMMM dd, YYYY hh:mm a" />
                                            </span></c:if>
                                        </div>
                                    </div>
                                </div>
