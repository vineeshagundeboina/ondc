    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 col-sm-9 col-xs-12">
            	...
            	<c:if test="${not empty action && action eq 'acctlist'}">
            	<script>
                ...
                <c:if test="${not empty managedAccounts}">
                <script>
                    alert_box("success", "Account list updated successfully.");
                </script>
                </c:if>

                <c:if test="${managedAccounts eq 'null' }">
                <script>
                    ...
                    <div class="content-application-form">
                        <div class="card text-white mb-3">
                            <div class="card-header font-weight-bold  bg-success">
                                Application Status: &nbsp;&nbsp;<i class="text-uppercase">Approved</i>
                            </div>
                        </div>
                            ...
                            <div class="card-body bg-white text-dark">
                                <div class="container">
                                    <div class="row row-info">
                                        ...
                                        <input type="hidden" value="${applicationDetails.id}" id="applicationId">
                                    </div>
                                    <div class="row row-info">
                                        <div class="col-3 font-weight-bold">
                                            Account Name :
                                                        ...
                                                        <div class="card mb-3 text-left">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="container">
                                                                    ...
                                                                    <form action="manageaccount" enctype="multipart/form-data" accept-charset="UTF-8" method="Post">
                                                                    <input type="hidden" name="accNo" value="${applicationDetails.accNo}">
                                                                    <input type="hidden" name="custNo" value="${applicationUser.custNo}">
                                                                    <input type="hidden" name="applicationFormId" value="${applicationDetails.id}">
                                                                    <input type="hidden" name="prefCorp" value="${applicationDetails.prefCorp}">
                                                                    <input type="hidden" name="prefNo" value="${applicationUser.prefNo}">
                                                          
                                                                    <button class="btn btn-sm btn-primary" type="submit" >Manage Account</button>
                                                                    </form>
                            ...
                            <div class="card-body bg-white text-dark">
                                <div class="container">
                                    ...
                                    <c:forEach var="document" items="${documents}">
                                        ...
                                        <div class="row row-info">
                                            <a target="_blank" href="fedservice/api/services/getFile/${document.filenetId}/SECURED">View Attachment</a>
                                            <div class="col-3 font-weight-bold">
                                                Type of Document :
                                            </div>
                                            <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="application_detail">
                                            <div class="col-auto mr-auto">
                                                ...
                                                <div class="row">
                                                    <div class="col-auto mr-auto">
                                                        <c:if test="${not empty  applicationDetails.modifiedAt}">

                                                            <span class="badge badge-secondary">Modified By :
                                                                ${applicationDetails.modifiedBy}</span>
                                                            <span class="badge badge-primary">
                                                                <fmt:formatDate value="${applicationDetails.modifiedAt}"
                                                                    pattern="MMMM dd, YYYY hh:mm a" /></span>
                                                        </c:if>
                                                    </div>
                                                </div>
                        ...
                        <a class="btn btn-lg btn btn-secondary" href="homepage">
