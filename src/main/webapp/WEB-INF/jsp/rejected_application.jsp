                    ...
                    <div class="content-application-form">
                        ...
                        <div class="card text-white mb-3">
	                        <div class="card-header font-weight-bold  bg-danger">
	                            Application Status: &nbsp;&nbsp;<i class="text-uppercase">Rejected</i>
	                        </div>
	                    </div>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="container">
                                                                    ...
                                                                    <div class="row row-info">
                                                                        ...
                                                                        <div>
                                                                                <c:if test="${applicationUser.transLimit ne null}">
                            ...
                            <div class="card-body bg-white text-dark">
                                <div class="container">
                                    ...
                                    <div class="row row-info">
                                        ...
                                        <div class="col">
                                        <c:choose>
                                        <c:when test="${applicationDetails.boardResolutionConfirmed eq 0 || applicationDetails.boardResolutionConfirmed eq null}">
                                        false
                                        </c:when>
                                        <c:otherwise>
                                      true 
                                    ...
                                    <div class="row row-info">
                                        ...
                                        <div class="col">
                                        <c:choose>
                                        <c:when test="${applicationDetails.modeOfOperationConfirmed eq 0 || applicationDetails.modeOfOperationConfirmed eq null}">
                                        	false
                                        </c:when>
                                        <c:otherwise>
                                        true
                        ...
                        <a class="btn btn-lg btn btn-secondary" href="rejectedlist">
